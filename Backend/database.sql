...
-- Order items table (if you need individual items)
...
-- Sample order
INSERT INTO `orders` (`user_id`, `total_amount`, `status`, `order_data`) VALUES
(1, 99.99, 'completed', '{"items": [{"name": "Product 1", "qty": 2, "price": 49.99}]}');

INSERT INTO `order_items` (`order_id`, `product_name`, `quantity`, `price`, `total`) VALUES
(1, 'Product 1', 2, 49.99, 99.98);